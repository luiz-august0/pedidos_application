...
@RestController
public class OrderController extends AbstractAllController<CustomerService, CustomerDTO> implements ICustomerController {
    OrderController(CustomerService service) {
        super(service);
    }
}
